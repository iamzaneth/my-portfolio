  ...
  const projects = [
    {
      ...
      image: "https://images.unsplash.com/photo-1557821552-17105176677c?fit=crop&w=800&q=80", // Ảnh mẫu
            ...
            <div key={index} className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 group">
              ...
              <div className="relative overflow-hidden h-48">
                ...
                <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-4">
                  <a href={project.github} target="_blank" className="p-2 bg-white rounded-full hover:bg-gray-200 transition-colors" title="View Code">
                    <Github size={20} className="text-gray-900"/>
                  </a>
                  <a href={project.demo} target="_blank" className="p-2 bg-white rounded-full hover:bg-gray-200 transition-colors" title="View Demo">
